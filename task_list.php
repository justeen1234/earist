	...
	<div class="card card-outline card-success">
		<div class="card-header">
			...
			<?php if ($_SESSION['login_type'] != 3): ?>
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_project"><i class="fa fa-plus"></i> Add New Routine</a>
			<?php endif; ?>	
			</div>
		</div>
		<div class="card-body">
							...
							<button type="button" class="btn btn-default btn-sm btn-flat border-info wave-effect text-info dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
		                      Action
			                    ...
			                    <div class="dropdown-menu" style="">
			                      <a class="dropdown-item new_productivity" data-pid = '<?php echo $row['pid'] ?>' data-tid = '<?php echo $row['id'] ?>'  data-task = '<?php echo ucwords($row['task']) ?>'  href="javascript:void(0)">Add Progress</a>
								</div>
						</td>
					</tr>	
				<?php endwhile; ?>
