...
<div class="col-lg-12">
				...
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<dl>
								<dt><b class="border-bottom border-primary">Coach</b></dt>
								<dd>
									...
									<?php else: ?>
										<small><i>No coach assigned</i></small>
									<?php endif; ?>
								</dd>
							</dl>
						</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<b>Player/s Progress</b>
					<div class="card-tools">
						<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_productivity"><i class="fa fa-plus"></i> New Progress</button>
					</div>
				</div>
				<div class="card-body">
					<?php 
